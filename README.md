...
- Favorite Quote card updated to avoid text overlap
...
- Sidebar and protected app layout restored after public landing page work

Feedback is currently handled on the frontend. Backend-connected feedback collection, full account creation, saved user data, and deeper onboarding are planned for later versions.
