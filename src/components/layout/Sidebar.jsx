...
function Sidebar({ activePage, setActivePage }) {
    ...
    return (
    <aside className="hidden md:flex flex-col w-56 min-h-screen bg-white dark:bg-dark-surface 
      backdrop-blur-xl border-r border-bloom-light dark:border-dark-border px-5 py-6">
