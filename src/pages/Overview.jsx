    ...
    <main className="min-h-screen p-6 lg:p-10">
      <section className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="rounded-3xl bg-bloom-light text-white p-8 lg:p-12 shadow-lg">
          <p className="text-bloom-forest font-semibold tracking-wide uppercase text-sm mb-4">
          ...
          <p className="text-bloom-forest text-lg lg:text-xl max-w-3xl leading-relaxed mb-8">
        ...
        <div className="rounded-3xl bg-bloom-light p-8 border border-bloom-sage">
          ...
          <h2 className="text-3xl font-bold text-bloom-forest mb-4">
            One step at a time
          </h2>

          <p className="text-bloom-navy leading-relaxed max-w-4xl">
        ...
        <div id="roadmap" className="rounded-3xl bg-white dark:bg-gray-800 border border-bloom-sage p-8 shadow">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="rounded-2xl bg-bloom-light p-4">
