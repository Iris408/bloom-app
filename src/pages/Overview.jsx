...
function PlantIcon({ className = "h-5 w-5" }) {
  return (
...
function SectionHeader({ eyebrow, title, text }) {
  return (
    <div className="mx-auto mb-6 max-w-3xl text-center min-[430px]:mb-8">
      {eyebrow && (
      ...
      <h2 className="text-xl font-bold leading-tight text-bloom-forest min-[390px]:text-2xl dark:text-bloom-light sm:text-3xl">
        {title}
      </h2>

      {text && (
        <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-bloom-forest/65 min-[430px]:mt-4 min-[430px]:leading-7 dark:text-gray-300 sm:text-base">
          {text}
        </p>
      )}
    </div>
...
function TrustPill({ children }) {
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-bloom-sage/20 bg-white/65 px-3 py-1.5 text-[11px] font-bold text-bloom-forest/65 shadow-sm min-[390px]:gap-2 min-[390px]:px-4 min-[390px]:py-2 min-[390px]:text-xs dark:border-white/10 dark:bg-white/5 dark:text-gray-300">
      {children}
    </span>
  )
}
...
function DemoPreviewCard({
  ...
  return (
    <article
      className={`flex h-full flex-col rounded-[1.25rem] border p-3.5 shadow-sm backdrop-blur-sm min-[430px]:rounded-[1.5rem] min-[430px]:p-4 ${
        featured
...
function HeroAppPreview() {
  return (
    <div className="relative mx-auto w-full max-w-[300px] min-[390px]:max-w-[320px] min-[430px]:max-w-[340px] lg:rotate-[4deg]">
      ...
      {/* Main card */}
      <div className="relative overflow-hidden rounded-[1.75rem] border border-bloom-sage/25 bg-white/78 p-4 shadow-[0_30px_80px_rgba(45,90,67,0.18)] backdrop-blur-md min-[430px]:rounded-[2.25rem] min-[430px]:p-5 dark:border-white/10 dark:bg-white/5"> 
        {/* Phone top bar */}
        ...
        <div className="mb-4 flex items-start justify-between gap-4">
          <div>
            ...
            <h3 className="mt-2 text-xl font-bold leading-tight text-bloom-forest min-[430px]:mt-3 min-[430px]:text-2xl dark:text-bloom-light">
              A softer start
            </h3>
        ...
        <div className="space-y-2.5 min-[430px]:space-y-3">
          {[
            ...
            <div
              key={title}
              className="rounded-[1.2rem] border border-bloom-sage/20 bg-white/80 p-3 min-[430px]:rounded-[1.35rem] min-[430px]:p-4 dark:border-white/10 dark:bg-white/5"
            >
        ...
        <div className="mt-4 rounded-[1.25rem] bg-bloom-light/75 p-3 min-[430px]:mt-5 min-[430px]:rounded-[1.5rem] min-[430px]:p-4 text-sm leading-6 text-bloom-forest/70 dark:bg-white/10 dark:text-gray-300">
          Small steps count. Rest counts too.
        </div>

        <div className="mt-4 rounded-[1.25rem] border border-dashed border-bloom-sage/25 bg-white/45 p-3 min-[430px]:mt-5 min-[430px]:rounded-[1.5rem] min-[430px]:p-4 dark:border-white/10 dark:bg-white/5">
...
function Overview({
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-transparent text-bloom-forest dark:text-bloom-light">
      ...
      <main className="relative mx-auto flex w-full max-w-7xl flex-col gap-8 px-3 pb-10 pt-20 min-[390px]:px-4 min-[430px]:gap-10 min-[430px]:pb-12 min-[430px]:pt-24 sm:gap-14 sm:px-6 sm:pb-20 sm:pt-32 lg:gap-16 lg:px-8">
        {/* HERO */}  
          <section className="grid items-center gap-5 py-2 min-[390px]:gap-6 min-[430px]:gap-7 min-[430px]:py-3 sm:gap-10 sm:py-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.75fr)] lg:py-12">          
            <div className="max-w-3xl text-center sm:pt-2 lg:text-left">
            <div className="mb-4 flex flex-wrap justify-center gap-1.5 min-[390px]:gap-2 min-[430px]:mb-5 lg:justify-start">
              <TrustPill>
                <HeartIcon />
                No pressure
              </TrustPill>
            ...
            <h1 className="text-[2rem] font-bold leading-[1.08] text-bloom-forest min-[390px]:text-[2.2rem] min-[430px]:text-4xl dark:text-bloom-light sm:text-5xl lg:text-6xl">              
              A calmer way to build your day.
            </h1>

            <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-bloom-forest/70 dark:text-gray-300 sm:mt-6 sm:text-base sm:leading-8 lg:mx-0">
              Bloom helps you create gentle routines, focus sessions, and daily
              steps without pressure, streaks, or shame.
            </p>

            <p className="mx-auto mt-2 max-w-2xl text-sm leading-6 text-bloom-forest/60 dark:text-gray-400 sm:mt-3 sm:leading-7 lg:mx-0">
              Designed for people who need structure, softness, and space to move at
              their own pace.
            </p>

            <div className="mx-auto mt-5 flex w-full max-w-sm flex-col gap-2.5 min-[430px]:mt-6 sm:mt-8 sm:max-w-none sm:flex-row sm:gap-3 lg:mx-0">
              <button
                type="button"
                onClick={onTryDemoClick}
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#d99a28] px-4 py-2.5 min-[390px]:px-5 min-[390px]:py-3 sm:px-6 sm:py-3.5 text-sm font-bold text-white shadow-[0_14px_28px_rgba(120,90,30,0.2)] transition hover:-translate-y-0.5 hover:bg-[#bd8420]"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-bloom-forest px-4 py-2.5 min-[390px]:px-5 min-[390px]:py-3 sm:px-6 sm:py-3.5 text-sm font-bold text-bloom-light shadow-[0_14px_28px_rgba(45,90,67,0.18)] transition hover:-translate-y-0.5 hover:bg-bloom-mid"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-bloom-sage/30 bg-white/72 px-4 py-2.5 min-[390px]:px-5 min-[390px]:py-3 sm:px-6 sm:py-3.5 text-sm font-bold text-bloom-forest shadow-sm transition hover:-translate-y-0.5 hover:bg-bloom-light dark:border-white/10 dark:bg-white/10 dark:text-bloom-light dark:hover:bg-white/15"
              >
        ...
        {/* START YOUR WAY */}
        <section className="hidden rounded-[2rem] border border-bloom-sage/25 bg-white/45 p-5 shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-white/5 sm:block sm:p-7">
          <SectionHeader
            eyebrow="Start your way"
            title={
              <span className="lg:whitespace-nowrap">
                Three simple paths, depending on what you need today.
              </span>
            }
        ...
        <section>
          <SectionHeader
            ...
            text="Try sample routines and focus tools without signing up."
          />

          <div className="grid grid-cols-1 gap-2.5 min-[430px]:gap-3 sm:grid-cols-2 sm:gap-5 xl:grid-cols-4">
            <DemoPreviewCard
              icon={<SunSmallIcon />}
              title="Simple Day"
